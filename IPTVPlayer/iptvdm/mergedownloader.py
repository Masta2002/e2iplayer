...
# Last Modified: 07.08.2026 - Extracted shared helpers (ensureText/fsPath/shellQuote/writeUtf8TextFile) and sidecar
# logic into downloaderhelpers.SidecarMixin, shared with wgetdownloader.py and hlsdownloader.py, instead of
# duplicating them here. Added 'clen'/'dur' URL-metadata fallback for merge:// downloads (YouTube audio/video
# streams): remote_size no longer relies solely on wget's "Length:" stderr line, and the ffmpeg chapter-duration
# probe falls back to the stream's 'dur' value when ffmpeg reports "Duration: N/A" on raw DASH-muxed files - Kamikaze24
###################################################
# LOCAL import
###################################################
