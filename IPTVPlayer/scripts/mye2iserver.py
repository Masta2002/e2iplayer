...
UPDATE_URL = 'https://github.com/Masta2002/e2iplayer/releases/download/mye2i-extension/mye2iv3-latest.zip'
...
<html>
    <body style="background-color: #c8dee1">
        <div id="mye2i_%s" style="background:#c0392b;color:#fff;padding:14px;text-align:center;font-family:sans-serif;font-size:16px;">
            Your MyE2i extension is outdated or unknown (v%s or newer needed). Please update:
            <a href="%s" style="color:#fff;text-decoration:underline;">Download new version</a>
        </div>
