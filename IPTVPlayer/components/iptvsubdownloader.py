...
class IPTVSubDownloaderWidget(Screen):
    ...
    def __prepareSkin(self):
        ...
        skin.append('<widget name="console" position="%d,%d" size="%d,%d" font="Regular;%d" transparent="1" zPosition="1" backgroundColor="black" foregroundColor="white" borderWidth="1" borderColor="black" />' % (_s(10), _s(450), _s(1000), _s(70), _s(20)))
