# -*- coding: utf-8 -*-
# Last Modified: 31.08.2022 - Web HU Player
###################################################
HOST_VERSION = "4.0"
###################################################
# LOCAL import
...
from Plugins.Extensions.IPTVPlayer.tools.iptvtools import printDBG, printExc, GetLogoDir, GetIPTVPlayerVersion, rm, rmtree, mkdirs, DownloadFile, GetFileSize, GetConfigDir, Which, MergeDicts
