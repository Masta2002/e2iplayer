...
class BtolatCom(CBaseHostClass):
    ...
    def getLinksForVideo(self, cItem):
        ...
        # was hardcoded to /hdd/IPTVCache/MovieMetaData - bypassed CacheDir
        # (and its storage-missing reroute) entirely, and the unguarded
        # os.makedirs() above could raise on a box with no /hdd at all;
        # GetMovieMetaDataDir() already creates the dir safely
