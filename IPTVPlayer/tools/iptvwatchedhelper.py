# -*- coding: utf-8 -*-
# added: 06.08.2026 - central watched helper for normal items, host lists and favourites,
# file based watched flag handling via hashed keys, item/list/host state updates,
# favourite hash synchronization, season/series parent propagation for episode items,
# grouped debug call handling, central config based write protection,
# custom menu action handling (mark/unmark watched via MENU key),
# incl. generic group/parent recompute helpers (recomputeGroupWatched/recomputeAllGroupsWatched)
# for season/series propagation on unmark - Kamikaze24
###################################################
# LOCAL import
###################################################
